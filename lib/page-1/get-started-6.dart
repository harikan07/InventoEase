  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Container(
        ...
        padding: EdgeInsets.fromLTRB(8 * fem, 106.84 * fem, 7 * fem, 128 * fem),
        width: double.infinity,
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              margin:
                  EdgeInsets.fromLTRB(13 * fem, 0 * fem, 0 * fem, 63.84 * fem),
              width: 344 * fem,
              height: 256.32 * fem,
              child: Image.asset(
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(14 * fem, 0 * fem, 0 * fem, 43 * fem),
            ...
            Container(
              ...
              padding:
                  EdgeInsets.fromLTRB(159 * fem, 18 * fem, 160 * fem, 18 * fem),
              width: double.infinity,
              height: 44 * fem,
              child: Container(
