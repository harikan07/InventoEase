  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Container(
        ...
        padding: EdgeInsets.fromLTRB(0 * fem, 102.95 * fem, 0 * fem, 125 * fem),
        width: double.infinity,
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              margin:
                  EdgeInsets.fromLTRB(0 * fem, 0 * fem, 16 * fem, 72.71 * fem),
              width: 271.45 * fem,
              height: 268.34 * fem,
              child: Image.asset(
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(0 * fem, 0 * fem, 16 * fem, 35 * fem),
